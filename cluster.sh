...
kubectl drain oda-worker --ignore-daemonsets --delete-emptydir-data
kubectl uncordon oda-worker
kubectl drain oda-worker2 --ignore-daemonsets --delete-emptydir-data
kubectl uncordon oda-worker2
fi
